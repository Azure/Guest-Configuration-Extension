# Contributing to Guest-Configuration-Extension
First, thank you for contributing to Guest-Configuration repository!
...
To open your own pull request, click [here](https://github.com/Azure/Guest-Configuration-Extension/compare). When creating a pull request, keep the following in mind:
